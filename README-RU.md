...
много несуществующих путей заглушки — и записывает его, чтобы оператор мог просмотреть и
заблокировать на файрволе; ответ при этом не меняется, поэтому сканер видит только заглушку и
маскировка сохраняется. TLS из
