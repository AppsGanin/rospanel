...
**Отключение не мгновенное.** Превышение должно продержаться от двух с половиной до трёх
минут — чуть дольше окна онлайна (лимиты устройств панель проверяет раз в 30 секунд). Так
сделано потому, что два самых частых способа превысить лимит —
