    ...
    <Modal open onClose={onClose} title="Добавить ноду" size="lg">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-ink-muted">
          Нода сразу пытается получить сертификат Let's Encrypt (домен или голый
          IP — для IP короткоживущий, как на самой панели). Если ACME пока не
          отработал, нода временно поднимается на самоподписанном, панель вшивает
          его отпечаток в ссылки (клиенты подключаются сразу), и нода продолжает
          повторять ACME — как только настоящий серт выдастся, она автоматически
          его подхватит.
        </p>
