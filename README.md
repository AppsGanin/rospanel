...
подписки, тарифы, маршрутизация, статистика, бэкапы, брендинг и тема — без правки
конфигов руками.
...
- **Тарифные планы**: цена (₽), срок действия, лимиты трафика и устройств, флаг
  «бесплатный». Редактируются в **Настройки → Тарифы**
...
- **Заказы на оплату**: клиент выбирает платный тариф в боте → создаётся заказ →
  админ подтверждает оплату (с вводом своего пароля) → тариф и лимиты применяются
