#!/usr/bin/env bash
#
# RosPanel quick installer (Fork: Shu1t3/rospanel-shu1t3).
#
#   curl -Ls https://raw.githubusercontent.com/Shu1t3/rospanel-shu1t3/main/install-fork.sh | sudo bash
#
...
#
#   curl -Ls https://raw.githubusercontent.com/Shu1t3/rospanel-shu1t3/main/install-fork.sh | sudo bash -s -- --join 'https://panel/…/v1/join#<token>'
#
